...
const SingleProduct = () => {
    ...
    const getSingleProduct = async () => {
        try {
            ...
            setSingleProduct(res.data) // التصحيح هنا
    ...
    useEffect(()=> {
        getSingleProduct() // استدعاء الدالة بشكل صحيح
    }, [])
            ...
            SingleProduct ? <div className='px-4 pb-4 md:px-0'>
                    ...
                    <div className='max-w-6xl mx-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-10'>
                        ...
                        <div className='flex flex-col gap-6'>
                            <h1 className='me:text-3xl text-xl font-bold text-gray-800'>{SingleProduct.title}</h1>
                            ...
                            <div className='flex gap-4 mt-4'>
                                    <button onClick={()=>addToCart(SingleProduct)} className='px-6 flex gap-2 text-lg items-center bg-red-500 text-white rounded-md cursor-pointer'><IoCartOutline className='w-6 h-6'/> Add to Cart</button>
                            </div>
                        </div>
