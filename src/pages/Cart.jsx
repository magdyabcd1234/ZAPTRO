          ...
          <div>
            <div className='mt-10'>
              ...
              <div className='bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                ...
                <p className='font-semibold text-lg'>${Math.floor(totalPrice + 5)}</p>
                </div>
                ...
                <div>
                  ...
                  <div className='flex gap-3'>
                    ...
                    <button className='bg-white text-black border border-gray-200 px-4 cursor-pointer py-1 rounded-md transition-all hover:bg-red-500'>Apply</button>
                  </div>
                </div>
