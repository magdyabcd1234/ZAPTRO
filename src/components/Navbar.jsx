            ...
            <div className='md:flex gap-1 cursor-pointer text-gray-700 items-center hidden'>
              ...
              </div>
              {
                ...
                border-2 p-5 border-gray-100 rounded-md'>
                  ...
                  <button onClick={getLocation} className='bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer hover:bg-red-400 transition-all'>Detect my location</button>
                </div> : null
              }
          </div>
          {/* menu section  */}
